...
<img src="assets/harness-lint-readme.png" alt="harness lint —— 把 AI 反复犯的错变成快速、严格的 lint 规则" width="860" />
...
> **面向编码 Agent 的 Lint Driven Development** —— 当 AI 不听指令时，把那次纠正固化成一条快速、严格的 lint 规则，让它无法再犯同样的错。
